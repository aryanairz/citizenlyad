...
export const TapIndicator: React.FC<{startFrame?: number}> = ({startFrame = 0}) => {
  ...
  return <div style={{position: 'absolute', left: '50%', top: '50%', width: 48, height: 48, marginLeft: -24, marginTop: -24, borderRadius: '50%', border: `4px solid ${colors.red}`, transform: `scale(${scale})`, opacity}} />;
};
