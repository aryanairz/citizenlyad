...
export const TapIndicator: React.FC<{startFrame?: number}> = ({startFrame = 0}) => {
  ...
  return <div style={{position: 'absolute', right: 27, top: '50%', width: 48, height: 48, marginTop: -24, borderRadius: '50%', border: `4px solid ${colors.red}`, transform: `scale(${scale})`, opacity}} />;
};
